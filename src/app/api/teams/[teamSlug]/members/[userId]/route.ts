...
type Params = { params: Promise<{ teamSlug: string; userId: string }> }

/** DELETE /api/teams/[teamSlug]/members/[userId] (teamSlug is the team UUID) */
export async function DELETE(request: NextRequest, { params }: Params) {
  const { teamSlug: teamId, userId } = await params
